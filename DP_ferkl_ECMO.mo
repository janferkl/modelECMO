...
package DP_ferkl_ECMO
  ...
  equation
    ...
    connect(DeadSpace.solutionFlow, product6.y) annotation (Line(points={{-194,689},
            {-194,724},{227,724},{227,184}},      color={0,0,127}));
    connect(pH_Arteries.referenceFluidPort, Arteries.q_in[6]) annotation (Line(
        points={{-180,-141.8},{-180,-176},{-125.9,-176},{-125.9,-160.634}},
        color={127,0,0},
        thickness=0.5));
    connect(RespRate.y, product6.u1) annotation (Line(points={{263,152},{256,
            152},{256,178},{250,178}}, color={0,0,127}));
    ...
    connect(product11.y, product6.u2) annotation (Line(points={{285,198},{274,198},
            {274,188},{250,188},{250,190}}, color={0,0,127}));
